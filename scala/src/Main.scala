...
object MainApp extends IOApp.Simple:
  val d1 =
    for
      ...
      day8 <- getNonEmptyLines[IO]("./resources/day8.txt")
      day9 <- getNonEmptyLines[IO]("./resources/day9.txt")
      day10 <- getNonEmptyLines[IO]("./resources/day10.txt")
      ...
      // _ <- IO.println(s"Day eight one: ${dayEight.solveOne(day8)}")
      _ <- IO.println(s"Day eight two: ${dayEight.solveTwo(day8)}")
      _ <- IO.println(s"Day nine one: ${nine.solveOne(day9.toVector)}")
      _ <- IO.println(s"Day nine one: ${nine.solveTwo(day9.toVector)}")
      _ <- IO.println(s"Day ten one: ${ten.solveOne(day10)}")
      // _ <- IO.println(s"Day ten two: ${ten.solveTwo(day10)}")
